...
2. Alternatively, select the "Add app" button on the Applications overview page:![The image shows how to find the Add app button from AppSignal's Applications dashboard](<.gitbook/assets/image (1).png>)
...
<figure><img src=".gitbook/assets/image.png" alt="Image showing AppSignal&#x27;s app settings dashboard with push &#x26; deploy keys"><figcaption><p>App Settings dashboard</p></figcaption></figure>
