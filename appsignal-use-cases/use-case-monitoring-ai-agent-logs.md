...
{% hint style="info" %}
This guide assumes you have an AppSignal account and have already followed the [Getting Started](https://karen-de-souza.gitbook.io/appsignal-demo/documentation/broken-reference) guide to install and configure AppSignal in your Python project.
{% endhint %}
